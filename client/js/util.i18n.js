...
const LANGUAGES = {
	en: {
		...
		translations: {
			...
			'ui.enter': 'ENTER',
			'ui.join': 'Join',
			'ui.invite_room_label': 'Room',
			'ui.invite_note': 'Room info comes from the invite link — just set your nickname',
			'ui.invite_password_filled': '🔒 Password filled',
			'ui.invite_no_password': 'No password',
			'ui.invite_old_link': '⚠️ Old format',
			'ui.invite_manual': 'Enter room info manually',
			'ui.today': 'Today',
			'ui.yesterday': 'Yesterday',
			'ui.load_earlier': 'Show earlier messages',
			'ui.tagline': 'End-to-end encrypted · Zero-knowledge · Anonymous',
			'ui.connecting': 'Connecting...',
			'ui.connect_failed': 'Connection failed, please try again',
			...
			'call.drag_to_move': 'Drag to move · double-click to reset',
			...
			'call.declined': 'declined the call',
			'call.busy': 'is busy',
			'call.no_answer': 'No one answered',
			'call.canceled': 'Call canceled',
			'call.failed': 'Call failed',
			'call.missed': 'Missed call',
			'call.mic_error': 'Unable to access microphone. Please check browser permissions and devices.',
			'call.unsupported': 'Voice calls are not supported in this browser.',
			'call.cannot_reach': 'Cannot reach',
			'call.already_in_call': 'You are already in a call.',
			'call.user_left': 'left the call',
			...
			'system.room_empty': 'You are alone in this room — messages stay on this device only.',
			'system.server_key_changed': '⚠️ The server encryption key changed since your last visit — if you did not expect this, avoid sharing sensitive info.',
			'system.share_link_warning': '⚠️ Anyone with this link can join the room — share it only with trusted people.',
	...
	zh: {
		...
		translations: {
			...
			'ui.enter': '确定',
			'ui.join': '加入',
			'ui.invite_room_label': '房间',
			'ui.invite_note': '房间信息来自邀请链接，只需填写你的昵称',
			'ui.invite_password_filled': '🔒 密码已填充',
			'ui.invite_no_password': '无需密码',
			'ui.invite_old_link': '⚠️ 旧格式链接',
			'ui.invite_manual': '手动输入房间信息',
			'ui.today': '今天',
			'ui.yesterday': '昨天',
			'ui.load_earlier': '显示更早的消息',
			'ui.tagline': '端到端加密 · 零信任 · 完全匿名',
			'ui.connecting': '连接中...',
			'ui.connect_failed': '连接失败，请重试',
			...
			'call.drag_to_move': '拖动调整位置 · 双击复位',
			'call.incoming_call': '来电：语音通话',
			'call.calling': '正在呼叫...',
			'call.connecting': '连接中...',
			'call.reconnecting': '连接中断，正在重连...',
			'call.accept': '接听',
			'call.decline': '拒接',
			'call.hang_up': '挂断',
			'call.mute': '静音',
			'call.unmute': '取消静音',
			'call.speaker': '扬声器',
			'call.speaker_on': '扬声器已开启',
			'call.speaker_off': '扬声器已关闭',
			'call.ended': '通话已结束',
			'call.declined': '拒绝了通话',
			'call.busy': '正忙',
			'call.no_answer': '对方无应答',
			'call.canceled': '通话已取消',
			'call.failed': '通话失败',
			'call.missed': '未接来电',
			'call.mic_error': '无法访问麦克风，请检查浏览器权限或设备',
			'call.unsupported': '当前浏览器不支持语音通话',
			'call.cannot_reach': '暂时无法联系',
			'call.already_in_call': '你正在通话中',
			'call.user_left': '离开了通话',
			'call.call_declined': '已拒绝通话',
			...
			'system.room_empty': '当前房间只有你一个人，消息仅保存在本机，新成员加入后不会看到之前的消息。',
			'system.server_key_changed': '⚠️ 服务器加密密钥与上次不同，如非你预期，请勿发送敏感信息。',
			'system.share_link_warning': '⚠️ 任何拿到此链接的人都能进入房间，请只发给信任的人。',
